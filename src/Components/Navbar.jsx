      ...
      <div className=" mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex-shrink-0 flex items-center">
            <a href="/" className="">
                <img src="https://nate-dashboard-frontend.vercel.app/static/media/logo%201.dc376ed811cf9ff03040.png" alt='logo' className=' w-full h-14'/>
            </a>
          </div>
          <div className="flex items-center">
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8" id='nav'>
              <a href="/" className="text-white  px-3 py-2 rounded-md text-lg font-semibold" id='nav'>Home</a>
              <a href="/" className="text-white  px-3 py-2 rounded-md text-lg font-semibold" id='nav'>AI+</a>
              {/* <a href="/" className="text-white  px-3 py-2 rounded-md text-lg font-semibold" id='nav'>AI Resume Fetch</a> */}
              <a href="/" className="text-white  px-3 py-2 rounded-md text-lg font-semibold" id='nav'>Resources</a>
              <a href="/" target='_blank' className="text-white  px-3 py-2 rounded-md text-lg font-semibold" id='nav'>Services</a>
              <a href="/" target='_blank' className="text-white  px-3 py-2 rounded-md text-lg font-semibold" id='nav'>Blog</a>
              <a href="/login" className="text-white px-2 py-2 text-lg font-semibold border-2 rounded-xl " id='home_fourth'>Log in</a>
              <a href="/signup" className="text-white  px-2 py-2 text-lg font-semibold border-2 rounded-xl" id='nav'>Sign up</a>
            </div>
